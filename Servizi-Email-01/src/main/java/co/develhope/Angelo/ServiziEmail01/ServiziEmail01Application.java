...
Servizi - Email 01
    ...
    if Gmail is not allowing you to have Less secure apps, you can use a service like SendGrid
    ...
    you should receive an email like the one shown in the pic email-received.PNG
 */

package co.develhope.Angelo.ServiziEmail01;
